...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("maxVerifyAttempts", "Max verification attempts", "Maximum number of wrong OTP entries allowed per authentication session before the code is invalidated and authentication fails. Defaults to 3.", ProviderConfigProperty.STRING_TYPE, "3"),
