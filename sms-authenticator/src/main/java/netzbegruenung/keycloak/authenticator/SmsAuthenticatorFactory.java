...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("otpLockoutSeconds", "OTP lockout duration (seconds)", "How long the OTP step stays locked for a user after the maximum wrong attempts is reached. Defaults to 900 (15 minutes).", ProviderConfigProperty.STRING_TYPE, "900"),
